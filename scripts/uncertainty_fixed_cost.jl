...
if test
    ...
    NPZ.npzwrite("output/simulations_uncertainty_fixed_cost/I_policy_s12.npy",sol_scenario2.I_policy)
    NPZ.npzwrite("output/simulations_uncertainty_fixed_cost/Delta_I_policy_s12.npy",sol_scenario2.Delta_I_policy)
end
